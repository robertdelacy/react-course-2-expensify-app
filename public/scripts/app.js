...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function deleteSingleOption(removeOption) {
...
var Options = function Options(props) {
    return React.createElement(
        ...
        props.options.map(function (option, key) {
            return React.createElement(Option, { deleteSingleHandler: props.deleteSingleHandler, key: key, option: option });
        })
    );
};
...
var Option = function Option(props) {
    return React.createElement(
        ...
        React.createElement(
            'button',
            { onClick: props.deleteSingleHandler },
            'Remove'
        )
    );
};
